...
Version 0.7 is the first packaging-ready release. The same source tree now
...
```text
dist-appimage/ViiZeyMix-0.7.0-x86_64.AppImage
dist-appimage/ViiZeyMix-0.7.0-x86_64.AppImage.sha256
```
...
5. Create and push the matching tag, for example `v0.7.0`.
